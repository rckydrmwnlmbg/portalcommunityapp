...
import 'package:portalcommunity/screens/admin/kontendetail.dart';

class KontenAdmin extends StatefulWidget {
  const KontenAdmin({Key? key}) : super(key: key);

  @override
  State<KontenAdmin> createState() => _KontenAdminState();
}

class _KontenAdminState extends State<KontenAdmin> {
  Future getBerita() async {
    var res = await CallApi().getData('admin/kontenkreatif');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Data Konten Kreatif'),
